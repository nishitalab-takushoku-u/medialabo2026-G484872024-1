...
function print(data) {
    ...
    for (let i = 0; i < shops.length; i++) {
        ...
        console.log("店名: " + shops[i].name);
        console.log("住所: " + shops[i].address);
        console.log("キャッチコピー: " + shops[i].catch);
        console.log("予算: " + shops[i].budget.name);
        console.log("ジャンル: " + shops[i].genre.name);
    }
}
